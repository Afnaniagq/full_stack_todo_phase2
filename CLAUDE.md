...
## Technology Stack for Full-Stack Todo Application

### data-modeling-sqlmodel
Use for designing the SQLModel schema, managing Neon migrations, and ensuring data isolation.

### cryptographic-auth-jwt
Use for bridging the JWT handshake between Next.js and FastAPI to secure all API calls.

### api-engineering-fastapi
Use for building FastAPI routes, processing business logic, and enforcing Pydantic data validation.

### fullstack-ui-nextjs-app-router
Use for creating the Next.js interface, styling with Tailwind, and managing user-side state.

### workflow-governance-spec-kit-plus
Use for auditing the project, maintaining the /specs directory, and preventing code from drifting from requirements.
